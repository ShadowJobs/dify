...
from models.model import App, AppMode, AppModelConfig, Conversation, EndUser, Message, MessageFeedback
...
class LinMessageService:
    ...
    def pagination_by_first_id(
        ...
        conversation = LinMessageService.get_conversation(
